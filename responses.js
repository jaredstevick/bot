module.exports = [
    ...
    {
        "keywords": ["ivanka", "Ivanka", "daughter"],
        "messages": [
            "I’ve said if Ivanka weren’t my daughter, perhaps I’d be dating her."
        ]
    },
    {
        "keywords": ["hand", "hands", "finger", "fingers"],
        "messages": [
    ...
    {
        "keywords": ["fat", "drink", "drinking", "drinks"],
        "messages": [
    ...
    {
        "keywords": ["IQ", "iq", "smart", "intelligent", "intelligence", "stupid"],
        "messages": [
